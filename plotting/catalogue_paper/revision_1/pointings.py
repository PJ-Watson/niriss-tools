...
if __name__ == "__main__":
    ...
    img_path = (
        ...
        / "JwstMosaics"
        / "v7"
        / "abell2744clu-grizli-v7.2-f200w-clear_drc_sci.fits.gz"
    )
    ...
    ax.legend(legend_handles, legend_labels, loc=4, handlelength=1.5)

    fig.patch.set_alpha(0.0)

    plt.savefig(save_dir / "pointings_rev1.pdf", dpi=600)
